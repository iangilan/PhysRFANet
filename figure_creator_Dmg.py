...
from utils import dice_loss, save_plot_Dmg_each
import config
import utils
...
def test_model(model, test_loader):
    ...
    if dataset_type == "foreseen":
        figure_path = f"{figure_path_Dmg}/{model.__class__.__name__}_seen/fig_each"
    elif dataset_type == "unforeseen":
        figure_path = f"{figure_path_Dmg}/{model.__class__.__name__}_unseen/fig_each"
    else:
    ...
    # save plots
    save_plot_Dmg_each(all_predictions, all_labels, all_Ninput, figure_path)
