...
attunet_train_loss = np.loadtxt('RFAAttUNet_Dmg_train_loss.txt')
attunet_valid_loss = np.loadtxt('RFAAttUNet_Dmg_valid_loss.txt')
cnn_train_loss     = np.loadtxt('RFACNN_Dmg_train_loss.txt')
cnn_valid_loss     = np.loadtxt('RFACNN_Dmg_valid_loss.txt')
unet_train_loss    = np.loadtxt('RFAUNet_Dmg_train_loss.txt')
unet_valid_loss    = np.loadtxt('RFAUNet_Dmg_valid_loss.txt')
...
# Save the figure
plt.savefig('Dmg_losses_plot.png')
