...
def load_data(file_paths):
    ...
    return Dmg_train_data, Ninput_train_data, MR_train_data, Dmg_test_data_foreseen, Dmg_test_data_unforeseen, Ninput_test_data_foreseen, Ninput_test_data_unforeseen, MR_test_data_foreseen, MR_test_data_unforeseen
